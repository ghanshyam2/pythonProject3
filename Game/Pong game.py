...
while True:
    ...
    if ball.xcor() > 390:
        ...
        pen.clear()
        pen.write("Player A: {}                    Player B: {} ".format(player_a_score, playerBscore),
    ...
    if (ball.xcor()) < -390:  # Left width paddle Border
        ball.goto(0, 0)
        # ball_dx = ball_dx * -1
        player_b_score = playerBscore + 1
        pen.clear()
        pen.write("Player A: {}                    Player B: {} ".format(playerAscore, player_b_score),
                  align="center", font=('Monaco', 24, "normal"))
        os.system("afplay wallhit.wav&")
